...
public class BuildVars {
    ...
    public static int APP_ID = 24350028;
    public static String APP_HASH = "7be6b2896509b4e82d4a6011d0f8b6fa";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "org.fisko.telegram.messenger.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
